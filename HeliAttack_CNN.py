...
SAVE_MODEL = False
TIMESTEPS = 120000 #1000000

# Naming Convention
# "Model_Timeframe_data source_SHAPE_Reward Function_added observations_#itteration"
model_name = "PPO_HeliAttack2_MultiInputPolicy_Gray_Reward2_3"
...
# Models
# model = DQN("MlpPolicy", env, verbose=0, exploration_fraction=0.75, buffer_size=9000, tensorboard_log=logdir) # exploration_fraction=0.95 batch_size=256
model = PPO("MultiInputPolicy", env, verbose=0, tensorboard_log=logdir)
